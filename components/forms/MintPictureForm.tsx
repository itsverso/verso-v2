	...
	return (
		<div className="flex flex-col bg-white h-screen">
			<div className="w-full h-24 flex items-center justify-between px-6 bg-[#FAFAFA]">
				<div>
					<h1 className="font-hedvig text-2xl md:text-2xl">
						New Verso
					</h1>
				</div>
				<div>
			...
			<div
				className={`w-full h-full flex flex-col justify-between py-4 px-6 `}
			>
				<div className="w-full flex flex-col">
					...
					<div className={``}>
						<label className="h-full w-full flex flex-col mt-4">
							...
							{imageError ? (
								<p className="text-rose-700 text-xs mt-2 mb-4">
									{imageError}
								</p>
							) : null}
							<input
