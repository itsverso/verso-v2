...
// Contract adddresses: SEPOLIA
// MARKET
export const MARKET_MASTER_ADDRESS__SEPOLIA =
	"0x6b7625Bc2A4BE1C4A28a6e1cfA73026F226DbFE9";
export const MARKET_MASTER_IMPLEMENTATION_ADDRESS__SEPOLIA =
	"0xB5A6234E7b3B1D5361B9299644a3C6609AF0e185"; // Do not use this one, it's just the implementation.
// COLLECTION
export const COLLECTION_IMPLEMENTATION_ADDRESS__SEPOLIA =
	"0xfb944cf529e7448d6B11941d90E12368Dd028f8a";
// FACTORY
export const COLLECTION_FACTORY_ADDRESS__SEPOLIA =
	"0x7f11b50F5864f8B83F3Ae15b3aA4d3473A723624";
// COLLECTION REGISTRY
export const COLLECTION_REGISTRY_IMPLEMENTATION_ADDRESS__SEPOLIA =
	"0xCF07f7BA3861192c145c53EA979E04FA9fAb8A24"; // Do not use this one, it's just the implementation.
export const COLLECTION_REGISTRY_ADDRESS__SEPOLIA =
	"0x1FC1bAFEF0A2D8C1203d0D11aBA4FDFC5Ffd5081";
// PROFILE REGISTRY
export const PROFILE_REGISTRY_ADDRESS__SEPOLIA =
	"0x33F67739DE6c7d12e87514d0A0673129400ea216";
